Black tern 0.1 is an open source program to calculate the values of the wave velocity field under linear wave theory, the program uses a .txt file with ordered values to read the main wave properties as the amplitude and period. The program then writes the wave field values into several .txt files. 
